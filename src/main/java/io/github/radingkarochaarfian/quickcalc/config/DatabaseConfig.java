...
public class DatabaseConfig {
  ...
  private void setDefaultValue() {
    ...
    prop.setProperty(KEY_URL,
        "jdbc:sqlserver://localhost:1433;databaseName=QuickCalcDB;encrypt=true;trustServerCertificate=true;loginTimeout=1;connectRetryCount=0;");
    prop.setProperty(KEY_MASTER_URL,
        "jdbc:sqlserver://localhost:1433;encrypt=true;trustServerCertificate=true;loginTimeout=1;connectRetryCount=0;");
